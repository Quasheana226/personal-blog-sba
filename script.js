...
// Reseting the form
function resetForm() {
  titleInput.value = ""; //  Title should be clean
  contentInput.value = ""; // content should be clean
...
postsContainer.addEventListener("click", function (event) {
  ...
  if (clicked.classList.contains("delete-btn")) {
    handleDelete(Number(clicked.getAttribute("data-id")));}
  
  if (clicked.classList.contains("edit-btn")) {
    handleEdit(Number(clicked.getAttribute("data-id")));
  }
});
//
loadFromStorage();
